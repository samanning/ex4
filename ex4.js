...
$(document).ready(function () {
    ...
    $('#agenda').click(function () {
        $(this).attr('src', 'media/agenda.png').animate({
            ...
            $('p#answerAgenda').css('visibility', 'visible');
    return false;
    });
    ...
    $('#pen').click(function () {
        ...
        $('p#answerPen').css('visibility', 'visible');
    return false;
    });
    ...
    $('#keys').click(function () {
        ...
        $('p#answerKeys').css('visibility', 'visible');
    return false;
    });
    ...
    $('#burts').click(function () {
        ...
        $('p#answerBurts').css('visibility', 'visible');
    return false;
    });
    ...
    $('#phone').click(function () {
        ...
        $('p#answerPhone').css('visibility', 'visible');
    return false;
    });
